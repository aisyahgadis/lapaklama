        ...
        <div class="tracking-grid">
            ...
            <div class="tracking-card">
                ...
                @else
                    ...
                    <a href="{{ route('penjual.form') }}" style="display: inline-block; margin-top: 15px; padding: 10px 20px; background: #0b5f75; color: white; border-radius: 10px; text-decoration: none;">Buat Permintaan</a>
                @endif
            </div>
                            ...
                            <div class="timeline-content">
                                ...
                                @if($recycle->penjahit)
                                    <div style="background: #f8fafc; border: 1px solid #cbd5e1; border-radius: 12px; padding: 15px; margin-top: 10px;">
                                        ...
                                        <form action="{{ route('penjual.recycle.update-resi', $recycle->id) }}" method="POST">
                                            @csrf
