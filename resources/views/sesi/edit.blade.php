    ...
    <div class="row login-container w-100 m-0">
            ...
            <form action="{{ url('/profil/update') }}" method="POST">
                ...
                @if($user->role === 'pembeli')
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="name" name="name" placeholder="Masukkan nama lengkap Anda" value="{{ old('name', $user->name) }}" required>
                    </div>
                ...
                <div class="d-flex gap-2 mt-4 mb-4">
                    ...
                    <button type="submit" class="btn btn-tosca w-50 rounded-3 py-2">Simpan Profil</button>
                </div>
            </form>
        </div>
        ...
        <div class="col-lg-6 login-visual-section d-none d-lg-flex">
            ...
            <div class="visual-icon">
                <i class="bi bi-person-gear"></i> </div>
            <h3 class="fw-bold mb-2 text-center">Pengaturan Akun</h3>
            <p class="text-center opacity-75 small" style="max-width: 340px;">
                Pastikan data diri dan informasi kontak Anda selalu *up-to-date* untuk kelancaran transaksi di Lapaklama.
            </p>
        </div>
